                    ...
                    <div class="row formtype">
                        <div class="col-md-6 ">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="{{ $permintaan->kode_permintaan }} "
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="sel1" name="model">
                                    ...
                                    @foreach ($model as $ml)
                                        <option {{ $permintaan->model_id == $ml->kode_model_item ? 'selected' : '' }}
                                            value="{{ $ml->kode_model_item }}">{{ $ml->nama_model_item }}</option>
                                    @endforeach
                                </select>
                                @error('model')
                                    <span class="text-danger">{{ $message }}</span>
