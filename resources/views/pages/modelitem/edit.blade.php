...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ url('update-model/' . $modelItem->id) }}" method="POST">
                    @csrf
                    <div class="row formtype">
                        <div class="col-md-6 ">
                            <div class="form-group">
                                <label>Kode Model Item</label>
                                <input class="form-control" type="text" value="{{ $modelItem->kode_model_item }} "
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="sel1" name="nama_customer">
                                    ...
                                    @foreach ($customer as $cm)
                                        <option {{ $modelItem->customer_id == $cm->id ? 'selected' : '' }}
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="ITEM A" name="nama_model"
                                    value="{{ $modelItem->nama_model_item }}">
                                @error('nama_model')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="sel1" name="nama_material">
                                    ...
                                    @foreach ($material as $mt)
                                        <option {{ $modelItem->material_id == $mt->id ? 'selected' : '' }}
