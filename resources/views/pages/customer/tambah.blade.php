...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ url('post-customer') }}" method="POST">
                    @csrf
                    <div class="row formtype ">
                        <div class="col-md-6 ">
                            <div class="form-group">
                                <label>Kode Customer</label>
                                <input class="form-control" type="text" value="{{ $kode_customer }} "
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" id="comment" name="alamat_customer"></textarea>
